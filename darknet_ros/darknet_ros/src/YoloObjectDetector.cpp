...
void YoloObjectDetector::init() {
  ...
  nodeHandle_.param("yolo_model/weight_file/name", weightsModel, std::string("yolov3.weights"));
  nodeHandle_.param("weights_path", weightsPath, std::string("/weights"));
  ...
  nodeHandle_.param("config_path", configPath, std::string("/cfg"));
